...
// getting Firestore instance from Firestore provider
  ...
  FutureVoid createCommunity(Community community) async {
    try {
      ...
      if (communityDoc.exists) {
        throw "Community name was existed";
      }
...
// lay thong tin User trong Community tai Firebase
  ...
  // community collection ( firebase ) -> particular community ( name)
  // getting a snapshot and mapping it -> take any snapshot and convert is to community model
